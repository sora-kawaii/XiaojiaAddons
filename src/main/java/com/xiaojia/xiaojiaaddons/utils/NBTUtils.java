...
public class NBTUtils {
   public static boolean getBooleanFromExtraAttributes(ItemStack var0, String var1) {
      ...
      return var2 != null && var2.hasKey(var1) ? var2.getBoolean(var1) : false;
   }
   ...
   public static List getLore(ItemStack var0) {
      return (List)(var0 == null ? new ArrayList() : var0.getTooltip(XiaojiaAddons.mc.thePlayer, XiaojiaAddons.mc.gameSettings.advancedItemTooltips));
   }
