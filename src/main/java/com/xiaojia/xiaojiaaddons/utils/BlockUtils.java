...
public class BlockUtils {
   ...
   public static ArrayList getSurfaceMid(Vec3 var0, BlockPos var1) {
      ...
      if (var0.yCoord < (double)var4) {
         var2.add(new Face((double)var3, (double)var4 + var6, (double)var5, (double)(var3 + 1), (double)var4 + var6, (double)(var5 + 1)));
      }

      if (lllIlllIIIl(var0.yCoord, (double)(var4 + 1)) > 0) {
         var2.add(new Face((double)var3, (double)(var4 + 1) - var6, (double)var5, (double)(var3 + 1), (double)(var4 + 1) - var6, (double)(var5 + 1)));
      }

      if (var0.xCoord < (double)var3) {
         var2.add(new Face((double)var3 + var6, (double)var4, (double)var5, (double)var3 + var6, (double)(var4 + 1), (double)(var5 + 1)));
      }

      if (lllIlllIIIl(var0.xCoord, (double)(var3 + 1)) > 0) {
         var2.add(new Face((double)(var3 + 1) - var6, (double)var4, (double)var5, (double)(var3 + 1) - var6, (double)(var4 + 1), (double)(var5 + 1)));
      }

      if (var0.zCoord < (double)var5) {
         var2.add(new Face((double)var3, (double)var4, (double)var5 + var6, (double)(var3 + 1), (double)(var4 + 1), (double)var5 + var6));
      }

      if (lllIlllIIIl(var0.zCoord, (double)(var5 + 1)) > 0) {
         var2.add(new Face((double)var3, (double)var4, (double)(var5 + 1) - var6, (double)(var3 + 1), (double)(var4 + 1), (double)(var5 + 1) - var6));
      }
   ...
   public static BlockPos getLookingAtPos(int var0) {
      Vector3d var1 = getLookingAtVector((double)var0);
      return new BlockPos(var1.x, var1.y, var1.z);
   }

   private static int lllIlllIIIl(double var0, double var2) {
      double var4;
   ...
   public static boolean isBlockAir(float var0, float var1, float var2) {
      return isBlockAir((double)var0, (double)var1, (double)var2);
   }
   ...
   public static MovingObjectPosition watchingAt() {
      return MinecraftUtils.getPlayer().rayTrace((double)XiaojiaAddons.mc.playerController.getBlockReachDistance(), 0.0F);
   }
