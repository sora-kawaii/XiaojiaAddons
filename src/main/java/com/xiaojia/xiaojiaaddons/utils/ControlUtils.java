...
public class ControlUtils {
   ...
   public static boolean checkHoldingItem(String var0) {
      ...
      var1.add(var0);
      return checkHoldingItem((List)var1);
   }
   ...
   public static void etherWarp(double var0, double var2, double var4) throws Exception {
      ...
      Thread.sleep((long)(SkyblockUtils.getPing() + 50));
      rightClick();
      Thread.sleep((long)(SkyblockUtils.getPing() + 100));
      unSneak();
   }
   ...
   public static void faceSlowly(float var0, float var1, boolean var2) throws InterruptedException {
      ...
      if (lIllIlIIlIl(var3, 0.0F) < 0) {
         var3 += 360.0F;
      }

      if (lIllIlIIlIl(var0, 0.0F) < 0) {
         var0 += 360.0F;
      }
      ...
      int var7 = MathUtils.floor(Math.sqrt(Math.pow((double)(var3 - var0), 2.0) + Math.pow((double)(var4 - var1), 2.0)) / (double)var6) + 1;
      ...
      for(int var8 = 1; var8 <= var7; ++var8) {
         ...
         while(lIllIlIIlIl(var9, -180.0F) < 0) {
            var9 += 360.0F;
         }
   ...
   public static boolean differentDirection(float var0, float var1) {
      return IIlIllIIlIl((double)Math.abs(MathUtils.getYaw() - var0), 0.01) > 0 && (double)Math.abs(MathUtils.getYaw() - var0) < 359.99 || IIlIllIIlIl((double)Math.abs(MathUtils.getPitch() - var1), 0.01) > 0;
   }
   ...
   private static int IllIllIIlIl(float var0, float var1) {
      float var2;
   ...
   public static Tuple getFaceYawAndPitch(float var0, float var1, float var2) {
      ...
      float var10 = (float)Math.sqrt((double)((var4 - var0) * (var4 - var0) + (var6 - var2) * (var6 - var2)));
      float var11 = (float)Math.atan2((double)var8, (double)var10);
      float var12 = -180.0F / var3 * var11;

      float var13;
      for(var13 = (float)(Math.atan2((double)var9, (double)var7) + (double)(3.0F * var3 / 2.0F)); IllIllIIlIl(var13, -var3) < 0; var13 += 2.0F * var3) {
      }
   ...
   public static boolean checkHotbarItemRegistryName(int var0, String var1) {
      ...
      if (var0 != -1 && var2 != null) {
         ItemStack var3 = getItemStackInSlot(var0 + 36, true);
         return var3 == null ? false : var3.getItem().getRegistryName().toLowerCase().contains(var1);
      } else {
         return false;
      }
   }
   ...
   public static void changeDirection(float var0, float var1) {
      if (!(var1 > 90.0F) && lllIIlIIlIl(var1, -90.0F) >= 0 && lllIIlIIlIl(var0, -180.0F) >= 0 && !(var0 > 180.0F)) {
   ...
   private static int lllIIlIIlIl(float var0, float var1) {
      float var2;
      return (var2 = var0 - var1) == 0.0F ? 0 : (var2 < 0.0F ? -1 : 1);
   }
   ...
   public static boolean reportedFacing(double var0, double var2) {
      try {
         ...
         double var6 = (double)var4.getFloat(MinecraftUtils.getPlayer());
         double var8 = (double)var5.getFloat(MinecraftUtils.getPlayer());
   ...
   private static int lIllIlIIlIl(float var0, float var1) {
      float var2;
      return (var2 = var0 - var1) == 0.0F ? 0 : (var2 < 0.0F ? -1 : 1);
   }
   ...
   public static boolean checkHoldingItem(List var0) {
      return getOpenedInventory() != null && getOpenedInventory().getSize() == 45 ? checkHotbarItem(getHeldItemIndex(), var0) : false;
   }
   ...
   private static int IIlIllIIlIl(double var0, double var2) {
      double var4;
