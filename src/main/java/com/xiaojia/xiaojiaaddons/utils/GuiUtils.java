...
public class GuiUtils {
   ...
   public static void showTitle(String var0, String var1, int var2, int var3, int var4) {
      ...
      var5.displayTitle(ChatLib.addColor(var0), (String)null, var2, var3, var4);
      var5.displayTitle((String)null, ChatLib.addColor(var1), var2, var3, var4);
      var5.displayTitle((String)null, (String)null, var2, var3, var4);
   }
   ...
   public static void drawString(String var0, float var1, float var2, float var3, int var4, float var5, boolean var6) {
      ...
      if (var6) {
         ...
         float var12 = (float)Math.sqrt((double)var11);
   ...
   private static void renderBeaconBeam(double var0, double var2, double var4, int var6, float var7) {
      ...
      double var13 = (double)((float)Minecraft.getMinecraft().theWorld.getTotalWorldTime() + MathUtils.partialTicks);
      ...
      var12.pos(var0 + var22, var2 + (double)var10, var4 + var24).tex(1.0, var40).color(var17, var18, var19, 1.0F * var7).endVertex();
      ...
      var12.pos(var0 + var26, var2 + (double)var10, var4 + var28).tex(0.0, var40).color(var17, var18, var19, 1.0F * var7).endVertex();
      var12.pos(var0 + var34, var2 + (double)var10, var4 + var36).tex(1.0, var40).color(var17, var18, var19, 1.0F * var7).endVertex();
      ...
      var12.pos(var0 + var30, var2 + (double)var10, var4 + var32).tex(0.0, var40).color(var17, var18, var19, 1.0F * var7).endVertex();
      var12.pos(var0 + var26, var2 + (double)var10, var4 + var28).tex(1.0, var40).color(var17, var18, var19, 1.0F * var7).endVertex();
      ...
      var12.pos(var0 + var34, var2 + (double)var10, var4 + var36).tex(0.0, var40).color(var17, var18, var19, 1.0F * var7).endVertex();
      var12.pos(var0 + var30, var2 + (double)var10, var4 + var32).tex(1.0, var40).color(var17, var18, var19, 1.0F * var7).endVertex();
      ...
      var12.pos(var0 + var22, var2 + (double)var10, var4 + var24).tex(0.0, var40).color(var17, var18, var19, 1.0F * var7).endVertex();
      var11.draw();
   ...
   public static void renderBeaconBeam(BlockPos var0, int var1, float var2) {
      double var3 = (double)((float)var0.getX() - MathUtils.getX(MinecraftUtils.getPlayer()));
      double var5 = (double)((float)var0.getY() - MathUtils.getY(MinecraftUtils.getPlayer()));
      double var7 = (double)((float)var0.getZ() - MathUtils.getZ(MinecraftUtils.getPlayer()));
   ...
   private static void drawLineWithDepthRelative(float var0, float var1, float var2, float var3, float var4, float var5, Color var6, int var7) {
      ...
      worldRenderer.pos((double)var0, (double)var1, (double)var2).endVertex();
      worldRenderer.pos((double)var3, (double)var4, (double)var5).endVertex();
      tessellator.draw();
      GL11.glEnable(3553);
      GL11.glDepthMask(true);
      GL11.glDisable(3042);
   ...
   private static void drawFilledBoundingBoxRelative(float var0, float var1, float var2, float var3, float var4, float var5, int var6, int var7, int var8, int var9) {
      ...
      worldRenderer.pos((double)var0, (double)var1, (double)var2).endVertex();
      worldRenderer.pos((double)var3, (double)var1, (double)var2).endVertex();
      worldRenderer.pos((double)var3, (double)var1, (double)var5).endVertex();
      worldRenderer.pos((double)var0, (double)var1, (double)var5).endVertex();
      tessellator.draw();
      worldRenderer.begin(7, DefaultVertexFormats.POSITION);
      worldRenderer.pos((double)var0, (double)var4, (double)var5).endVertex();
      worldRenderer.pos((double)var3, (double)var4, (double)var5).endVertex();
      worldRenderer.pos((double)var3, (double)var4, (double)var2).endVertex();
      worldRenderer.pos((double)var0, (double)var4, (double)var2).endVertex();
      tessellator.draw();
   ...
   private static void drawBoxAt(float var0, float var1, float var2, int var3, int var4, int var5, int var6, float var7, float var8) {
      ...
      worldRenderer.begin(3, DefaultVertexFormats.POSITION);
      worldRenderer.pos((double)(var0 + var7), (double)(var1 + var8), (double)(var2 + var7)).endVertex();
      worldRenderer.pos((double)(var0 + var7), (double)(var1 + var8), (double)(var2 - var7)).endVertex();
      worldRenderer.pos((double)(var0 - var7), (double)(var1 + var8), (double)(var2 - var7)).endVertex();
      worldRenderer.pos((double)(var0 - var7), (double)(var1 + var8), (double)(var2 + var7)).endVertex();
      worldRenderer.pos((double)(var0 + var7), (double)(var1 + var8), (double)(var2 + var7)).endVertex();
      worldRenderer.pos((double)(var0 + var7), (double)var1, (double)(var2 + var7)).endVertex();
      worldRenderer.pos((double)(var0 + var7), (double)var1, (double)(var2 - var7)).endVertex();
      worldRenderer.pos((double)(var0 - var7), (double)var1, (double)(var2 - var7)).endVertex();
      worldRenderer.pos((double)(var0 - var7), (double)var1, (double)(var2 + var7)).endVertex();
      worldRenderer.pos((double)(var0 - var7), (double)var1, (double)(var2 - var7)).endVertex();
