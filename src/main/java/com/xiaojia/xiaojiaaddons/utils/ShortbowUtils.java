...
public class ShortbowUtils {
   ...
   private static int IllIllIIl(double var0, double var2) {
      double var4;
   ...
   public static Vector2d getDirection(double var0, double var2, double var4, double var6, double var8, double var10, boolean var12) {
      ...
      double var37;
      double var31;
      while(lllIllIIl(var29 - var27, 0.01) > 0) {
      ...
      if (enabled) {
         ...
         while(var2.hasNext()) {
            ...
            if (var3 instanceof EntityArrow) {
               Cube var4 = new Cube((double)MathUtils.getX(var3), (double)(MathUtils.getY(var3) - 0.1F), (double)MathUtils.getZ(var3), 0.10000000149011612, 0.10000000149011612);
   ...
   public static double getProjectileFunction(double var0, double var2, boolean var4) {
      ...
      return var0 / (var5 * 0.049 * Math.cos(var2)) * (var5 * 0.049 * Math.sin(var2) + 1.0) - 1.0 * var7 / 0.049;
   }
   ...
   public static void testTerminator() {
      (new Thread(() -> {
         try {
            double var0 = (double)MathUtils.getX(MinecraftUtils.getPlayer());
            double var2 = (double)(MathUtils.getY(MinecraftUtils.getPlayer()) + MinecraftUtils.getPlayer().getEyeHeight());
            double var4 = (double)MathUtils.getZ(MinecraftUtils.getPlayer());
            ...
            for(int var17 = 0; var17 < 200; ++var17) {
               double var18 = x_t(var8, (double)((float)var17 / 10.0F), true);
               double var20 = y_t(var8, (double)((float)var17 / 10.0F), true);
               double var22 = x_t(var12, (double)((float)var17 / 10.0F), false);
               double var24 = y_t(var12, (double)((float)var17 / 10.0F), false);
   ...
   public static Vector2d calcYawPitchEnderCrystal(double var0, double var2, double var4) {
      double var6 = (double)MathUtils.getX(MinecraftUtils.getPlayer());
      double var8 = (double)(MathUtils.getY(MinecraftUtils.getPlayer()) + MinecraftUtils.getPlayer().getEyeHeight());
      double var10 = (double)MathUtils.getZ(MinecraftUtils.getPlayer());
      return getDirection(var6, var8, var10, var0, var2 + 1.0, var4);
   }

   private static int lIIIllIIl(double var0, double var2) {
      double var4;
      return (var4 = var0 - var2) == 0.0 ? 0 : (var4 < 0.0 ? -1 : 1);
   }
   ...
   private static int lllIllIIl(double var0, double var2) {
      double var4;
      return (var4 = var0 - var2) == 0.0 ? 0 : (var4 < 0.0 ? -1 : 1);
   }
   ...
   public static Vector2d[] getLeftMiddleYawPitchByRight(Vector2d var0) {
      ...
      assert Math.abs(var1 - var12) < 1.0E-4 || lIIIllIIl(Math.abs(var1 - var12), 359.9999) > 0;

      return new Vector2d[]{var11[0], new Vector2d(var9, var5)};
   }

   private static double getNewPitch(double var0) {
      assert IlllIlIIl(var0, -90.0) >= 0 && var0 <= 90.0;
   ...
   private static double getRawPitch(double var0) {
      assert IIIlIlIIl(var0, -90.0) >= 0 && var0 <= 90.0;

      return (1.5707963267948966 + var0) / (1.0 + 0.017453292519943295 * (double)(var0 < -1.5707963267948966 ? -1 : 1));
   }

   private static int IlllIlIIl(double var0, double var2) {
      double var4;
      return (var4 = var0 - var2) == 0.0 ? 0 : (var4 < 0.0 ? -1 : 1);
   }
   ...
   public static Vector2d[] getMiddleRightYawPitchByLeft(Vector2d var0) {
      ...
      assert Math.abs(var1 - var12) < 1.0E-4 || IllIllIIl(Math.abs(var1 - var12), 359.9999) > 0;

      return new Vector2d[]{new Vector2d(var9, var5), var11[1]};
   }

   private static int IIIlIlIIl(double var0, double var2) {
      double var4;
      return (var4 = var0 - var2) == 0.0 ? 0 : (var4 < 0.0 ? -1 : 1);
   }
}
