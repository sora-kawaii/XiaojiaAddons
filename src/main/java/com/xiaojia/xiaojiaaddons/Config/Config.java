...
public class Config {
   ...
   public static void save() {
      try {
         ...
         Files.write(Paths.get("config/XiaojiaAddons.cfg"), var4.getBytes(StandardCharsets.UTF_8), new OpenOption[0]);
   ...
   public static ArrayList collect(Class var0) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         Property var7 = (Property)var6.getAnnotation(Property.class);
         if (var7 != null) {
            switch (var7.type()) {
               case BOOLEAN:
