...
public class ChestProfit {
               ...
               try {
                  ...
                  while(var7.hasNext()) {
                     ...
                     if (var9.endsWith(" Coins")) {
                        var5 = (double)(-Integer.parseInt(var9.substring(0, var9.length() - 6).replaceAll(",", "")));
                     }
                  }
                  ...
                  String var13 = "§c";
                  if (lIIIIIlIlIIl(var5, 700000.0) > 0) {
                     var13 = "§a";
                  } else if (lIIIIIlIlIIl(var5, 0.0) > 0) {
                     var13 = "§2";
                  }
   ...
   private static int lIIIIIlIlIIl(double var0, double var2) {
      double var4;
   ...
   private static String getStringProfit(double var0) {
      ...
      if (IlllllIIlIIl(var0, 1000000.0) >= 0) {
         return var2 + String.format("%.2fM", var0 / 1000000.0);
      } else {
         return IlllllIIlIIl(var0, 1000.0) >= 0 ? var2 + String.format("%.2fK", var0 / 1000.0) : var2 + String.format("%.0f", var0);
      }
   }

   private static int IlllllIIlIIl(double var0, double var2) {
      double var4;
      return (var4 = var0 - var2) == 0.0 ? 0 : (var4 < 0.0 ? -1 : 1);
   }
}
