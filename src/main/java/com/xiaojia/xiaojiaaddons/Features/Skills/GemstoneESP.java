...
public class GemstoneESP {
   ...
   private static int lIllllll(double var0, double var2) {
      double var4;
      ...
      if (isEnabled()) {
         ...
         while(var2.hasNext()) {
            ...
            if (isGemstoneEnabled((Gemstone)var3.getValue())) {
               double var4 = Math.sqrt(((BlockPos)var3.getKey()).distanceSq((double)MathUtils.getX(MinecraftUtils.getPlayer()), (double)MathUtils.getY(MinecraftUtils.getPlayer()), (double)MathUtils.getZ(MinecraftUtils.getPlayer())));
               if (lIllllll(var4, (double)(Configs.GemstoneRadius + 2)) <= 0) {
   ...
   private static Gemstone getGemstone(IBlockState var0) {
      if (var0.getBlock() == Blocks.stained_glass || Configs.IncludeGlassPanes && var0.getBlock() == Blocks.stained_glass_pane) {
         EnumDyeColor var1 = (EnumDyeColor)var0.getValue(BlockStainedGlass.COLOR);
         if (var1 == null) {
            var1 = (EnumDyeColor)var0.getValue(BlockStainedGlassPane.COLOR);
         }
   ...
   public static enum Gemstone {
      ...
      private Gemstone(Color var3, EnumDyeColor var4) {
         this.color = var3;
         this.dyeColor = var4;
      }
   }
