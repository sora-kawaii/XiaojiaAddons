...
public class AutoPowder {
                           ...
                           (new Thread(() -> {
                              try {
                                 ...
                                 if (var1 != null && var1.typeOfHit.toString().equals("BLOCK")) {
                                    ...
                                    if (var2.getY() >= MathUtils.getBlockY(MinecraftUtils.getPlayer()) && MathUtils.distanceSquareFromPlayer((double)var2.getX() + 0.5, (double)var2.getY() + 0.5, (double)var2.getZ() + 0.5) <= Math.pow((double)XiaojiaAddons.mc.playerController.getBlockReachDistance(), 2.0)) {
   ...
   private static int llIIlllllll(double var0, double var2) {
      double var4;
         ...
         if (SkyblockUtils.isInCrystalHollows()) {
            if (var1.packet instanceof S2APacketParticles) {
               ...
               if (var2.getParticleType() == EnumParticleTypes.CRIT) {
                  ...
                  if (this.closestChest != null && MathUtils.distanceSquaredFromPoints((double)var3.x, (double)var3.y, (double)var3.z, (double)this.closestChest.getX() + 0.5, (double)this.closestChest.getY() + 0.5, (double)this.closestChest.getZ() + 0.5) < 1.0) {
   ...
   private BlockPos getClosest(int var1, int var2, int var3, int var4, int var5, int var6, Block var7, HashSet var8, boolean var9) {
      ...
      for(var12 = var10.getX() + var1; var12 <= var10.getX() + var2; ++var12) {
         for(int var13 = var10.getY() + var3; var13 <= var10.getY() + var4; ++var13) {
            for(int var14 = var10.getZ() + var5; var14 <= var10.getZ() + var6; ++var14) {
               ...
               if (MinecraftUtils.getWorld().getBlockState(var15).getBlock() == var7 && !var8.contains(var15) && MathUtils.distanceSquareFromPlayer((double)((float)var15.getX() + 0.5F), (double)((float)var15.getY() + 0.5F), (double)((float)var15.getZ() + 0.5F)) <= Math.pow((double)XiaojiaAddons.mc.playerController.getBlockReachDistance(), 2.0) && (!var9 || MathUtils.checkBlocksBetween(var12, var13, var14))) {
                  var11.add(var15);
               }
            }
         }
      ...
      var11.sort((var0_, var1x_) -> {
         ...
         return llIIlllllll(MathUtils.yawPitchSquareFromPlayer((float)var0.getX() + 0.5F, (float)var0.getY() + 0.5F, (float)var0.getZ() + 0.5F), MathUtils.yawPitchSquareFromPlayer((float)var1x.getX() + 0.5F, (float)var1x.getY() + 0.5F, (float)var1x.getZ() + 0.5F)) > 0 ? 1 : -1;
      });
      if (var11.isEmpty()) {
         return null;
      } else {
