...
public class AutoLobby {
      ...
      if (Checker.enabled) {
         if (!this.isSending) {
            if (MinecraftUtils.getPlayer() != null) {
               double var2 = (double)MathUtils.getY(MinecraftUtils.getPlayer());
               ...
               if (timeList[timeList.length - 1] != var4) {
                  ...
                  double var11 = (double)((float)(timeList[var6] - timeList[0]) / 1000.0F);
                  double var13 = (double)((float)(timeList[yCoordList.length - 1] - timeList[var6]) / 1000.0F);
                  ...
                  if (!(Math.abs(var19) < 1.0E-5) && IIIIIlIllll(velocity / var19, 30.0) <= 0) {
                     if (timeList[0] != -1L) {
   ...
   private static int IIIIIlIllll(double var0, double var2) {
      double var4;
