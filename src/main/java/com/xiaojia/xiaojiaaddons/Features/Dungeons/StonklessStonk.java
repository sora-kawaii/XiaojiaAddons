...
public class StonklessStonk {
                     ...
                     if (MinecraftUtils.getPlayer() != null) {
                        ...
                        try {
                           for(int var14 = 1; var14 <= 300; ++var14) {
                              ...
                              float var16 = (float)((double)var3 - Math.sin((double)var6) * Math.cos((double)var7) * (double)var15);
                              float var17 = (float)((double)var4 - Math.sin((double)var7) * (double)var15);
                              float var18 = (float)((double)var5 + Math.cos((double)var6) * Math.cos((double)var7) * (double)var15);
   ...
   private static int IIlIlIIIl(double var0, double var2) {
      double var4;
      ...
      if (Checker.enabled) {
         if (SkyblockUtils.isInDungeon()) {
            if (MinecraftUtils.getPlayer() != null && MinecraftUtils.getWorld() != null) {
               if (IIlIlIIIl(var1.position.distanceSq(MinecraftUtils.getPlayer().getPosition()), 20.0) <= 0) {
