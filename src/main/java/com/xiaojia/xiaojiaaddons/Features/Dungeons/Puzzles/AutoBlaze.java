...
public class AutoBlaze {
      ...
      while(var2.hasNext()) {
         ...
         if (var4.contains("Blaze") && var4.contains("/")) {
            ...
            try {
               ...
               var1.add(new BlazeInfo((double)MathUtils.getX(var3), (double)(MathUtils.getY(var3) - 1.0F), (double)MathUtils.getZ(var3), var6, var3));
   ...
   private static int IIIIllIIll(double var0, double var2) {
      double var4;
      ...
      for(int var7 = var5; var7 <= var6; var7 += 9) {
         ...
         for(int var9 = 0; var9 < 4; ++var9) {
            ...
            if (!BlockUtils.isBlockAir(var10, var8, var11) && BlockUtils.isBlockAir(var10, var8 + 1.0F, var11)) {
               places.add(new Vector3d((double)var10, (double)var8, (double)var11));
               log.append(String.format("add new place: %.2f %.2f %.2f", var10, var8, var11)).append("\n");
               Cube var12;
               if (var7 % 2 == 0) {
                  var12 = new Cube((double)var10, (double)((float)var7 / 2.0F) - 0.5, (double)var11, 0.5, 0.5);
               } else {
                  var12 = new Cube((double)var10, (double)var8, (double)var11, 0.5, 0.25);
               }
      ...
      for(Vector3d var4 = null; var3 < blazes.size(); var4 = var5) {
         ...
         while(var9.hasNext()) {
            ...
            while(var11 < blazes.size()) {
               ...
               if (IIlIIIlIll(var13.x, 1000.0) > 0 || IIlIIIlIll(var13.y, 70.0) > 0) {
                  break;
               }
   ...
   private static int lllIlIlIll(double var0, double var2) {
      double var4;
      return (var4 = var0 - var2) == 0.0 ? 0 : (var4 < 0.0 ? -1 : 1);
   }
   ...
   private void executeOrder(int var1, ArrayList var2) throws Exception {
      ...
      while(var5.hasNext()) {
         ...
         if (var6.type == AutoBlaze.BlazeOrder.Type.WARP) {
            ...
            long var9 = (long)MathUtils.floor(var7 * 50.0 / 1.7);
            log.append(String.format("distance: %.2f, estimate: %d\n", var7, var9));
            Thread.sleep((long)Configs.TurnShootDelay);
   ...
   private static int lIIlIlIIll(double var0, double var2) {
      double var4;
      return (var4 = var0 - var2) == 0.0 ? 0 : (var4 < 0.0 ? -1 : 1);
   }
   ...
   public void onEntityJoin(EntityJoinWorldEvent var1) {
      ...
      if (var2 instanceof EntityArrow) {
         ...
         if (var3 < 25.0) {
            log.append(String.format("entity join: " + var2.toString() + ", %.2f", var3)).append("\n");
   ...
   private void etherWarpTo(Vector3d var1) throws Exception {
      this.tpPacketReceived = false;
      Vector3d var2 = whereShouldIEtherWarpTo((double)MathUtils.getY(MinecraftUtils.getPlayer()), var1.x, var1.y, var1.z);
      ...
      if (lllIlIlIll(MathUtils.distanceSquareFromPlayer(var1.x, var1.y + 0.25 + (double)MathUtils.getEyeHeight(MinecraftUtils.getPlayer()), var1.z), 1.0) > 0) {
   ...
   private Vector3d getSecretPoint() throws Exception {
      ...
      for(int var4 = 0; var4 < 4; ++var4) {
         ...
         if (BlockUtils.isBlockBedRock((double)var5, (double)var1, (double)var6) && BlockUtils.isBlockWater((double)var5, (double)var1, (double)(var6 - var3[var4]))) {
            return new Vector3d((double)var5 + 0.5, (double)var1 + 0.75, (double)var6 + 0.5);
         }

         var5 = room.x + var2[var4] * 8;
         var6 = room.z + var3[var4] * 5;
         if (BlockUtils.isBlockBedRock((double)var5, (double)var1, (double)var6) && BlockUtils.isBlockWater((double)(var5 - var2[var4]), (double)var1, (double)var6)) {
            return new Vector3d((double)var5 + 0.5, (double)var1 + 0.75, (double)var6 + 0.5);
         }
      }
   ...
   private boolean canEtherwarpFromCur(Vector3d var1) throws Exception {
      return this.noBlocksBetween(new Vector3d((double)MathUtils.getX(MinecraftUtils.getPlayer()), (double)MathUtils.getY(MinecraftUtils.getPlayer()) + 1.54, (double)MathUtils.getZ(MinecraftUtils.getPlayer())), whereShouldIEtherWarpTo((double)MathUtils.getY(MinecraftUtils.getPlayer()), var1.x, var1.y, var1.z));
   }

   public static void test() {
      blazes.clear();
      lowFirst = true;
      blazes.add(new BlazeInfo(45.0, 51.0, 143.0, 10, (Entity)null));
      blazes.add(new BlazeInfo(49.0, 59.0, 143.0, 100, (Entity)null));
   ...
   public static boolean canHit(double var0, double var2, double var4, Vector2d var6, Cube var7, boolean var8) {
      ...
      if (isInXZSquare(var0, var4, var15, var17, var19, var21)) {
         ...
         if (IIIIllIIll(var27, var17) >= 0 && var27 < var21) {
            var35.add(new Vector2d(var15, var27));
         }

         if (IIIIllIIll(var31, var17) > 0 && var31 <= var21) {
            var35.add(new Vector2d(var19, var31));
         }

         if (IIIIllIIll(var29, var15) > 0 && var29 <= var19) {
            var35.add(new Vector2d(var29, var17));
         }

         if (IIIIllIIll(var33, var15) >= 0 && var33 < var19) {
   ...
   private static int IIlIIIlIll(double var0, double var2) {
      double var4;
      return (var4 = var0 - var2) == 0.0 ? 0 : (var4 < 0.0 ? -1 : 1);
   }
   ...
   public static Vector3d whereShouldIEtherWarpTo(double var0, double var2, double var4, double var6) throws Exception {
      ...
      return lIIlIlIIll(var0, var4 + 20.0) >= 0 ? new Vector3d(var2, var4 + var8, var6) : calculateSidePosToEtherWarp(var2, var4, var6);
   }
   ...
   static class BlazeInfo {
      ...
      public BlazeInfo(double var1, double var3, double var5, int var7, Entity var8) {
         this.cube = new Cube(var1, var3, var5, (double)((float)(1 * Configs.BlazeScale) / 100.0F), 0.3 * (double)Configs.BlazeScale / 100.0);
         this.hp = var7;
         this.hpEntity = var8;
      }
   }
