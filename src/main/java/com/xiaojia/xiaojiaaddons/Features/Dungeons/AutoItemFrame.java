...
public class AutoItemFrame {
      ...
      if (Checker.enabled) {
         if (Configs.AutoItemFrameArrows) {
            if (SkyblockUtils.isInDungeon()) {
               if (IlllIIIlIIl(MathUtils.distanceSquareFromPlayer(topLeft), 625.0) <= 0) {
                        ...
                        try {
                           ...
                           if (grid.size() < 25) {
                              ...
                              while(true) {
                                       ...
                                       do {
                                          if (!var18.hasNext()) {
                                             for(var2 = 0; var2 < 25; ++var2) {
                                                ...
                                                grid.add(var25);
                                                log.append(var25.toString()).append("\n");
                                             }
                                             break label201;
                                          }
                                 ...
                                 var14.add((EntityItemFrame)var20);
                              }
                           } else {
                              int var3;
                              int var5;
                              if (neededRotation.isEmpty()) {
                                 ...
                                 while(var19.hasNext()) {
                                    ...
                                    var5 = 1000;
                                    var25 = new MazeGrid((BlockPos)null, Type.EMPTY, new Vector2i(-1, -1));
                                    var7 = new HashMap();
                                    int var8 = -1;
                                 ...
                                 for(int var6 = 0; var6 < var5; ++var6) {
                                    ...
                                    Thread.sleep((long)Configs.ArrowCD);
                                 }

                                 Thread.sleep((long)Configs.ArrowCDBetween);
                              }
                           }
   ...
   private static int IlllIIIlIIl(double var0, double var2) {
      double var4;
