...
public class Dungeon {
   ...
   private void renderMap() {
      RenderUtils.drawImage(new Image(map), (double)Configs.MapX, (double)Configs.MapY, (double)(25 * Configs.MapScale), (double)(25 * Configs.MapScale));
   }
   ...
   private static int IllIlIlllIIl(double var0, double var2) {
      double var4;
   ...
   private static int IlIllIlllIIl(double var0, double var2) {
      double var4;
      return (var4 = var0 - var2) == 0.0 ? 0 : (var4 < 0.0 ? -1 : 1);
   }
   ...
   private void calcScore() {
      ...
      skillScore = Double.isNaN((double)skillScore) ? 20 : Math.max(skillScore, 20);
   ...
   public void onTickUpdateDungeon(TickEndEvent var1) {
      if (Configs.MapEnabled && SkyblockUtils.isInDungeon()) {
         ...
         try {
            ...
            secretsPercent = (double)this.getFloat((String)var3.get(44), Pattern.compile("Secrets Found: (.+)%"));
            ...
            overflowSecrets = IllIlIlllIIl((double)secretsFound, secretsForMax) > 0 ? (double)secretsFound - secretsForMax : 0.0;
   ...
   private void scan() {
      if (!isScanning) {
         ...
         for(int var4 = startX; (double)var4 <= (double)startX + (double)(roomSize + 1) * Math.floor((double)((float)endX / 31.0F - 1.0F)); var4 = (int)((double)var4 + Math.floor((double)((float)(roomSize + 1) / 2.0F)))) {
            for(int var5 = startZ; (double)var5 <= (double)startZ + (double)(roomSize + 1) * Math.floor((double)((float)endZ / 31.0F - 1.0F)); var5 = (int)((double)var5 + Math.floor((double)((float)(roomSize + 1) / 2.0F)))) {
               Room var6;
               if (IlIllIlllIIl(((double)var4 - (Math.floor((double)((float)roomSize / 2.0F)) + 24.0)) % (double)(roomSize + 1), 0.0) == 0 && IlIllIlllIIl(((double)var5 - (Math.floor((double)((float)roomSize / 2.0F)) + 24.0)) % (double)(roomSize + 1), 0.0) == 0) {
                  ...
                  int var7;
                  Room var8;
                  if (((var4 - (roomSize + 24)) % (roomSize + 1) == 0 && IlIllIlllIIl(((double)var5 - (Math.floor((double)((float)roomSize / 2.0F)) + 24.0)) % (double)(roomSize + 1), 0.0) == 0 || IlIllIlllIIl(((double)var4 - (Math.floor((double)((float)roomSize / 2.0F)) + 24.0)) % (double)(roomSize + 1), 0.0) == 0 && (var5 - (roomSize + 24)) % (roomSize + 1) == 0) && !MapUtils.isColumnAir(var4, var5)) {
         ...
         if (!var1.contains(var4.name) && !var4.type.equals("entrance")) {
            ...
            if (var4.checkmark.equals("green")) {
               if (Configs.DrawCheckMode == 1) {
                  RenderUtils.drawImage(greenCheck, (double)var5, (double)var6, 25.0, 25.0);
               } else if (Configs.DrawCheckMode == 2) {
                  RenderUtils.drawImage(newGreenCheck, (double)var5, (double)var6, 25.0, 25.0);
               }
            ...
            if (var4.checkmark.equals("white")) {
               if (Configs.DrawCheckMode == 1) {
                  RenderUtils.drawImage(whiteCheck, (double)var5, (double)var6, 25.0, 25.0);
               } else if (Configs.DrawCheckMode == 2) {
                  RenderUtils.drawImage(newWhiteCheck, (double)var5, (double)var6, 25.0, 25.0);
               }
            ...
            if (var4.checkmark.equals("failed")) {
               if (Configs.DrawCheckMode != 0) {
                  RenderUtils.drawImage(failedRoom, (double)var5, (double)var6, 25.0, 25.0);
               }
