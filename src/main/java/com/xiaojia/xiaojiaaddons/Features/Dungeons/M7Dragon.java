...
public class M7Dragon {
         ...
         if (SkyblockUtils.isInDungeon()) {
            if (SkyblockUtils.getDungeon().contains("7")) {
               if (var1.packet instanceof S2APacketParticles) {
                  ...
                  if (var2.getYCoordinate() < 10.0 || IllIIIIIIll(var2.getYCoordinate(), 28.0) > 0) {
                     return;
                  }
                  ...
                  while(var4.hasNext()) {
                     ...
                     if (var5.blockPos.distanceSq(var2.getXCoordinate(), (double)var5.blockPos.getY(), var2.getZCoordinate()) < 1.0) {
                        var3 = var5;
                     }
                  }
   ...
   private static int lllllIIIIll(double var0, double var2) {
      double var4;
   ...
   private static int IllIIIIIIll(double var0, double var2) {
      double var4;
      return (var4 = var0 - var2) == 0.0 ? 0 : (var4 < 0.0 ? -1 : 1);
   }
            ...
            if (MinecraftUtils.getWorld() != null) {
               ...
               while(var16.hasNext()) {
                  ...
                  if (var17 instanceof EntityDragon && dragonsMap.containsKey(var17)) {
                     ...
                     String var21 = "&a";
                     double var22 = (double)((EntityDragon)var17).getHealth();
                     if (var22 <= 1.0E8) {
                        var21 = "&c";
                     } else if (var22 <= 3.0E8) {
                        var21 = "&6";
                        ...
                        while(true) {
                              ...
                              while(var17.hasNext()) {
                                 ...
                                 while(var8.hasNext()) {
                                    ...
                                    while(var11.hasNext()) {
                                       ...
                                       if (lllllIIIIll(var13, 3.0) > 0 && var13 < 4.0) {
                                          ++var10;
                                       }
                                    }
                           ...
                           if (var5 != null) {
                              ...
                              if (var6.contains("Corrupted ")) {
                                 ...
                                 ((ArrayList)var0.get(var6)).add((EntityArmorStand)var4);
                              }
                              break;
                           }
                        }
